...
export const Route = createFileRoute("/policies")({
  head: () => ({
    meta: [
      { title: "Policies — Ario Stays" },
      { name: "description", content: "House rules, booking, cancellation, and stay policies at Ario Stays." },
      { property: "og:title", content: "Policies — Ario Stays" },
      { property: "og:description", content: "Booking, cancellation, and house policies." },
    ],
  }),
