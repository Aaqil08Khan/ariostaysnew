...
export const Route = createFileRoute("/villas")({
  head: () => ({
    meta: [
      { title: "Our Villas — Ario Stays" },
      { name: "description", content: "Browse our curated collection of luxury farmhouses and private villas around Hyderabad." },
      { property: "og:title", content: "Our Villas — Ario Stays" },
      { property: "og:description", content: "A curated collection of luxury farmhouses and private villas." },
    ],
  }),
