...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 group inline-flex items-center gap-3 rounded-full px-4 py-3 text-white transition hover:scale-[1.03]"
      style={{ backgroundColor: "var(--leaf)", boxShadow: "var(--shadow-elev)" }}
    >
      <span className="relative inline-flex h-9 w-9 items-center justify-center rounded-full" style={{ backgroundColor: "rgba(255,255,255,0.15)" }}>
        <span className="absolute inset-0 animate-ping rounded-full" style={{ backgroundColor: "rgba(255,255,255,0.2)" }} />
