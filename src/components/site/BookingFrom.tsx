  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-5 md:grid-cols-2">
      ...
      <div className="md:col-span-2">
        <button
          type="submit"
          className="inline-flex w-full items-center justify-center gap-2.5 rounded-full py-4 text-sm font-medium uppercase tracking-[0.2em] transition hover:opacity-90"
          style={{ backgroundColor: "var(--navy)", color: "var(--primary-foreground)" }}
        >
        ...
        <p className="mt-3 text-center text-[11px]" style={{ color: "var(--muted-foreground)" }}>
